...
namespace Persistence.Migrations
{
    ...
    [Migration("20241126185757_addedExhibitions")]
    partial class addedExhibitions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Exhibition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Issue", b =>
                {
                    ...
                    b.Property<int?>("ClientCardId1")
                        .HasColumnType("integer");

                    b.Property<int?>("ClientCardId2")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Book", b =>
                {
                    b.HasOne("Domain.Entities.Exhibition", "Exhibition")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Domain.Entities.Issue", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ClientCard", "ClientCard")
                        .WithMany()
                        .HasForeignKey("ClientCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.ClientCard", null)
                        .WithMany("Issues")
                        .HasForeignKey("ClientCardId1");

                    b.HasOne("Domain.Entities.ClientCard", null)
                        .WithMany("Returns")
                        .HasForeignKey("ClientCardId2");
